...
public class BookCategoryAdapter extends RecyclerView.Adapter<BookCategoryAdapter.CategoryHolder> {
    private static String url = "http://myoriental-music.com/service/icons/";
    MainActivity contentActivity;
    List<Category> categoryList;

    public BookCategoryAdapter(MainActivity activity, List<Category> categoryList) {
    ...
    public static class CategoryHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            contentActivity.showSubCategories(category,false);
        }
    }
}
